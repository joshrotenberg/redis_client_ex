defmodule RedisEx.Commands.JSON do
  @moduledoc """
  ...
  ## Usage
      ...
      RedisEx.Commands.JSON.set("user:1", %{name: "Alice", age: 30})
      #=> ["JSON.SET", "user:1", "$", ~s({"name":"Alice","age":30})]

      # With connection
      RedisEx.command(conn, JSON.set("doc", %{x: 1}))
      RedisEx.command(conn, JSON.get("doc"))
  """
