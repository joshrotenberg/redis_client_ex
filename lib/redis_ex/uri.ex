defmodule RedisEx.URI do
  ...
  ## Examples
      ...
      RedisEx.URI.parse("redis://localhost:6379")
      #=> [host: "localhost", port: 6379]

      RedisEx.URI.parse("redis://:secret@myhost:6380/2")
      #=> [host: "myhost", port: 6380, password: "secret", database: 2]

      RedisEx.URI.parse("rediss://user:pass@host:6379")
